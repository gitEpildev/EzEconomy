...
public class Lambda1EdgeCasesTest extends TestBase {
    ...
    public void lambda1_writes_empty_for_null_storage() throws Exception {
        ...
        // set storage to null and invoke lambda1 directly
    ...
    public void lambda1_handles_null_and_empty_allBalances() throws Exception {
        ...
        // Case: getAllBalances returns null
        ...
        // Case: getAllBalances returns empty map
