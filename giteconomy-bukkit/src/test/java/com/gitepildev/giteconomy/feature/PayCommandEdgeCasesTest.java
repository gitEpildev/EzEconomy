...
public class PayCommandEdgeCasesTest {
    ...
    public void testConfirmPendingTransferExecutes() throws Exception {
        ...
        com.gitepildev.giteconomy.command.PayCommand.createPendingTransfer(sender.getUniqueId(), recipient.getUniqueId(), "payeeC", Money.of(BigDecimal.valueOf(5), CURRENCY), CURRENCY, expires);
    ...
    public void testConfirmationThresholdCreatesPendingTransfer() throws Exception {
        ...
        assertTrue(com.gitepildev.giteconomy.command.PayCommand.isPendingConfirm(sender.getUniqueId()));
