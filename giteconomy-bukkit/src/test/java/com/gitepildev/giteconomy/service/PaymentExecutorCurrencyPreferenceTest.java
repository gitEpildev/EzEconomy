    ...
    void currencyPreference_fallbackLocalLock_depositsConvertedAmount() throws Exception {
        ...
        try {
            ...
            StorageProvider storage = new StorageProvider() {
                ...
                @Override public com.gitepildev.giteconomy.dto.EconomyPlayer getPlayer(java.util.UUID uuid) { return new com.gitepildev.giteconomy.dto.EconomyPlayer(uuid, uuid.toString(), uuid.toString()); }
                ...
                @Override public java.util.List<com.gitepildev.giteconomy.api.storage.models.Transaction> getTransactions(java.util.UUID uuid, String currency) { return java.util.Collections.emptyList(); }
                @Override public com.gitepildev.giteconomy.storage.TransferResult transfer(java.util.UUID fromUuid, java.util.UUID toUuid, String currency, double debitAmount, double creditAmount) { return com.gitepildev.giteconomy.storage.TransferResult.success(0,0); }
            ...
            plugin.setCurrencyManager(new com.gitepildev.giteconomy.manager.CurrencyManager(plugin));
