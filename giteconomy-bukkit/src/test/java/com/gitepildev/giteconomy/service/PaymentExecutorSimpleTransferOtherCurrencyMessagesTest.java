    ...
    void transferSuccess_sendsPaidOtherCurrencyAndReceivedOtherCurrency() throws Exception {
        ...
        try {
            ...
            StorageProvider storage = new StorageProvider() {
                ...
                @Override public com.gitepildev.giteconomy.storage.TransferResult transfer(UUID fromUuid, UUID toUuid, String currency, double debitAmount, double creditAmount) { return com.gitepildev.giteconomy.storage.TransferResult.success(90.0, 10.0); }
