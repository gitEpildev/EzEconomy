...
public class PlayerLookupTest {
    ...
    public void setup() throws Exception {
        ...
        org.bukkit.plugin.java.JavaPlugin plugin = (org.bukkit.plugin.java.JavaPlugin) org.mockbukkit.mockbukkit.MockBukkit.load(com.gitepildev.giteconomy.core.GitEconomyPlugin.class);
        try { plugin.getClass().getMethod("registerEconomy").invoke(plugin); } catch (Exception ignored) {}
        // Ensure cache is in a known state
        com.gitepildev.giteconomy.util.PlayerLookup.refreshCache();
    }
    ...
    public void findByName_prefersOnlineExactMatch() throws Exception {
        ...
        var opt = com.gitepildev.giteconomy.util.PlayerLookup.findByName("Derek");
    ...
    public void namesStartingWith_returnsMatchingNames() throws Exception {
        ...
        com.gitepildev.giteconomy.util.PlayerLookup.refreshCache();
        List<String> matches = com.gitepildev.giteconomy.util.PlayerLookup.namesStartingWith("Al");
    ...
    public void addAndRemoveCache_updatesNames() throws Exception {
        ...
        com.gitepildev.giteconomy.util.PlayerLookup.addToCache(player);
        String key = name.toLowerCase(Locale.ROOT);
        // inspect private CACHE via reflection to avoid flaky public helpers
        Field f = com.gitepildev.giteconomy.util.PlayerLookup.class.getDeclaredField("CACHE");
        f.setAccessible(true);
        @SuppressWarnings("unchecked") Map<String, ?> cache = (Map<String, ?>) f.get(null);
        assertTrue(cache.containsKey(key));
        com.gitepildev.giteconomy.util.PlayerLookup.removeFromCache(player);
    ...
    public void refreshCache_rebuildsFromServer() throws Exception {
        ...
        com.gitepildev.giteconomy.util.PlayerLookup.refreshCache();
        var opt = com.gitepildev.giteconomy.util.PlayerLookup.findByName("Frank");
        assertTrue(opt.isPresent());
    }

    @Test
    public void findByName_returnsEmptyForUnknown() {
        var opt = com.gitepildev.giteconomy.util.PlayerLookup.findByName("NoSuchPlayer123");
