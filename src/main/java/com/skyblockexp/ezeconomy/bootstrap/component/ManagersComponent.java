...
public class ManagersComponent implements BootstrapComponent {
    ...
    public void start() {
        ...
        com.skyblockexp.ezeconomy.manager.CurrencyPreferenceManager pref = new com.skyblockexp.ezeconomy.manager.CurrencyPreferenceManager();
        ...
        bank.start(interval);
        com.skyblockexp.ezeconomy.manager.DailyRewardManager drm = new com.skyblockexp.ezeconomy.manager.DailyRewardManager();
