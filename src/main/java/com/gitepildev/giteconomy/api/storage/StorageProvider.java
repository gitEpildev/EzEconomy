package com.gitepildev.giteconomy.api.storage;
...
public interface StorageProvider {
    ...
    default TransferResult transfer(UUID fromUuid, UUID toUuid, String currency, double debitAmount, double creditAmount) {
        ...
        com.gitepildev.giteconomy.core.GitEconomyPlugin inst = com.gitepildev.giteconomy.core.GitEconomyPlugin.getInstance();
        com.gitepildev.giteconomy.lock.LockManager lm = inst == null ? null : inst.getLockManager();
        if (lm == null) {
