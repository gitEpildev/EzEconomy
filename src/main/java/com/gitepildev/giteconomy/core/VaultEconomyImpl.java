...
/**
 * Vault Economy implementation for GitEconomy.
 */
public class VaultEconomyImpl implements Economy {
    private static final String INSUFFICIENT_FUNDS = "Insufficient funds";
    private final GitEconomyPlugin plugin;
    private final GitEconomyAPI api;

    public VaultEconomyImpl(GitEconomyPlugin plugin) {
        this.plugin = plugin;
        this.api = new GitEconomyAPI(plugin.getStorage());
    }
    ...
    private static final class LockedOperation implements AutoCloseable {
        private final com.gitepildev.giteconomy.lock.LockManager manager;
        private final UUID key;
        private final String token;
        private final ReentrantLock localLock;

        private LockedOperation(com.gitepildev.giteconomy.lock.LockManager manager, UUID key, String token, ReentrantLock localLock) {
