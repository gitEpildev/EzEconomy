...
public class GitEconomyMetrics {
    ...
    public GitEconomyMetrics(org.bukkit.plugin.Plugin plugin) {
        ...
        if (Boolean.getBoolean("giteconomy.test")) {
            this.metrics = null;
            return;
        }
        Metrics m = null;
        try {
            ...
            if (m != null) {
                try {
                    ...
                    try {
                        GitEconomyPlugin ez = (GitEconomyPlugin) plugin;
