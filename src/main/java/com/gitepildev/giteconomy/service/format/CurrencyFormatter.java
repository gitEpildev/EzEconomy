package com.gitepildev.giteconomy.service.format;
...
public class CurrencyFormatter {
    ...
    public CurrencyFormatter(GitEconomyPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public String formatShort(double amount, String currency) {
        ...
        String numeric = com.gitepildev.giteconomy.util.NumberUtil.formatShort(java.math.BigDecimal.valueOf(amount), decimals);
