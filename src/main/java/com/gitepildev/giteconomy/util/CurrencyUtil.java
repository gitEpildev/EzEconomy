...
public final class CurrencyUtil {
     ...
     */
    public static double convert(GitEconomyPlugin plugin, double amount, String from, String to) {
    ...
    public static double roundToCurrency(GitEconomyPlugin plugin, double value, String currency) {
     ...
     */
    public static ConversionResult convertBigDecimal(GitEconomyPlugin plugin, BigDecimal amount, String from, String to) {
