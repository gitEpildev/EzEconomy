...
public class CurrencyUtilTest {
    ...
    private GitEconomyPlugin pluginWithConfig(FileConfiguration cfg) {
        ...
        GitEconomyPlugin plugin = org.mockbukkit.mockbukkit.MockBukkit.load(GitEconomyPlugin.class);
        if (cfg != null) {
    ...
    public void inverseRateUsesReciprocal() {
        ...
        GitEconomyPlugin plugin = pluginWithConfig(cfg);
        try {
