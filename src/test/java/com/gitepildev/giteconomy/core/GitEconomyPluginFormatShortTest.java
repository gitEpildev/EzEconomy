...
public class GitEconomyPluginFormatShortTest {
    ...
    public void formatShort_perCurrencyEnabledAndThreshold() {
        ...
        assertEquals(plugin.getCurrencyFormatter().format(1500.0, "disabled"), plugin.getCurrencyFormatter().formatShort(1500.0, "disabled"));
