...
import com.gitepildev.giteconomy.feature.support.TestSupport.MockStorage;
...
public class EcoCommandFeatureTest {
    ...
    public void testEcoGiveSubcommand_runs() throws Exception {
        ...
        TestSupport.injectField(plugin, "vaultEconomy", new com.gitepildev.giteconomy.core.VaultEconomyImpl(plugin));
    ...
    public void testEco_withYMLStorage_depositPersists() throws Exception {
        ...
        com.gitepildev.giteconomy.storage.YMLStorageProvider yml = new com.gitepildev.giteconomy.storage.YMLStorageProvider(plugin, cfg);
