...
public class MySQLPayFeatureTest {
    ...
    public void setup() throws Exception {
        ...
        java.nio.file.Path pluginDir = java.nio.file.Paths.get("plugins", "GitEconomy");
        ...
        try {
            java.lang.reflect.Method initStorage = GitEconomyPlugin.class.getDeclaredMethod("initializeStorage");
        ...
        Field storageField = GitEconomyPlugin.class.getDeclaredField("storage");
