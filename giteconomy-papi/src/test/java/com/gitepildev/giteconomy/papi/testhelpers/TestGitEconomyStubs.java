...
public class TestGitEconomyStubs {
    ...
    public static class SimpleStorageProvider implements StorageProvider {
        ...
        private final Map<UUID, com.gitepildev.giteconomy.dto.EconomyPlayer> players = new HashMap<>();
    ...
    public static class SimpleTestEz implements GitEconomyPAPIExpansion.TestGitEconomy {
