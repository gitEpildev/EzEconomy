...
public class PAPIUnitHelpersTest {
    ...
    public void parseIntOrDefault_variousInputs() throws Exception {
        Method m = com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion.class.getDeclaredMethod("parseIntOrDefault", String.class, int.class);
    ...
    public void symbol_whenNull_returnsEmpty_forNonDollar() {
        com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion.TEST_ECONOMY_FOR_TESTS = com.gitepildev.giteconomy.papi.testhelpers.TestGitEconomyHelpers.emptyFormatting("euro");
    ...
    public void top_withBadNumber_returnsLoading_whenStorageNull() {
        com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion.TEST_ECONOMY_FOR_TESTS = com.gitepildev.giteconomy.papi.testhelpers.TestGitEconomyHelpers.emptyFormatting("dollar");
