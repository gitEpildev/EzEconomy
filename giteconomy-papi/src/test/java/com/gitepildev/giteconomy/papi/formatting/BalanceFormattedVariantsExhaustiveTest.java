...
public class BalanceFormattedVariantsExhaustiveTest {
    ...
    public void balance_formatted_and_short_variants_with_and_without_storage() throws Exception {
        ...
        TestGitEconomyStubs.SimpleTestEz stubWithStorage = new TestGitEconomyStubs.SimpleTestEz(storage, "usd");
        com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion.TEST_ECONOMY_FOR_TESTS = stubWithStorage;
        com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion expansion = new com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion(papi);
            ...
            org.bukkit.OfflinePlayer fake = com.gitepildev.giteconomy.papi.testhelpers.TestPlayerFakes.fakeOfflinePlayer(u);
        ...
        TestGitEconomyStubs.SimpleTestEz stubNoStorage = new TestGitEconomyStubs.SimpleTestEz(null, "eur");
        com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion.TEST_ECONOMY_FOR_TESTS = stubNoStorage;
        expansion = new com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion(papi);
    ...
    public void balance_identifiers_return_zero_when_offlineplayer_null() {
        ...
        com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion.TEST_ECONOMY_FOR_TESTS = new TestGitEconomyStubs.SimpleTestEz(null, "usd");
        com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion expansion = new com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion(papi);
