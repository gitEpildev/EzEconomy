...
public class TargetedExpansionCoverageTest {
    ...
    static class SimpleTestEz implements com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion.TestGitEconomy {
        ...
        @Override public com.gitepildev.giteconomy.manager.CurrencyPreferenceManager getCurrencyPreferenceManager() { return prefManager; }
    }

    static class MapStorage implements com.gitepildev.giteconomy.api.storage.StorageProvider {
    ...
    public void test_balance_and_currency_branches_with_test_hook() throws Exception {
        ...
        com.gitepildev.giteconomy.papi.GitEconomyPAPIExpansion.TEST_ECONOMY_FOR_TESTS = new SimpleTestEz(ms, "dollar", null);
